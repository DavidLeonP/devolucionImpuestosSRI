...
import com.d3v.modelo.DatosActualizar;
import com.d3v.modelo.DatosBeneficio;
import com.d3v.modelo.DatosBeneficioActualizar;
    ...
    public void actualizar(DatosActualizar datosActualizar) {
        ...
        while (retries < maxRetries) {
            try {
                ...
                String url = ConfiguracionURL.URL_ACTUALIZACION_ESTADO_DOCUMENTO;
                ...
                DatosBeneficioActualizar wrapper = new DatosBeneficioActualizar();
                Gson gson = new Gson();
                wrapper.setDatosBeneficio(datosActualizar);
