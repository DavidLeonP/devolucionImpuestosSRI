...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    if (!$estado) {
        $respuesta = array('status' => 'ERROR', 'mensaje' => 'Falta el parámetro estado en la URL');
    ...
    try {
        ...
        $consulta = "SELECT claveAcceso, rucEmisor, codigoBeneficio, idBeneficiario, baseImponible, porcentajeIva, montoIva FROM solicitudesDevolucionImpuesto WHERE estado = :estado";
